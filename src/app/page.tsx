...
function Square({ width, height, className, color, rotate }: { width: number, height: number, color: string, rotate?: string, className?: string }) {
    return (
...
function Circle({ radius, className, color, rotate }: { radius: number, color: string, rotate?: string, className?: string }) {
    return (
...
function Triangle({ width, height, className, color, rotate }: { width: number, height: number, color: string, rotate?: string, className?: string }) {
  ...
  return (
    <main className="w-screen h-screen flex flex-row justify-center bg-pink-2 p-3 overflow-hidden">
        <div className="max-w-[800px] w-full h-full flex flex-col justify-center items-center p-3 relative">
            <Square width={75} height={75} color="fill-red-1" className="absolute top-12 left-16 md:left-32 duration-200" rotate="z 45deg" />
            <Circle radius={50} color="fill-purple-1" className="absolute -bottom-12 right-16" />
            <Triangle width={100} height={100} color="fill-blue-4" className="absolute -right-4 opacity-70" rotate="z -60deg"/>
